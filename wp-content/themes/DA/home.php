...
}elseif(isset($_POST['homelayoutid']) && defined('WLT_DEMOMODE') ){  
 
	get_template_part( 'home', $_POST['homelayoutid'] );

}elseif(isset($GLOBALS['CORE_THEME']['homepage_layout']) && $GLOBALS['CORE_THEME']['homepage_layout'] != "" && $GLOBALS['CORE_THEME']['homeeditor'] != 1 ){
...
get_header($CORE->pageswitch());
		...
		if(isset($GLOBALS['CORE_THEME']['homepage']) && strlen($GLOBALS['CORE_THEME']['homepage']['widgetblock1']) > 1 && $GLOBALS['CORE_THEME']['homeeditor'] == 1){
