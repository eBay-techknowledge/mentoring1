           ...
           jQuery('#wlt_videobox_ajax_'+id+'_active video').mediaelementplayer({
		  	...
		  	success: function (mediaElement, domObject) { 
						...
						mediaElement.addEventListener('timeupdate', function(e) { 
							...
							jQuery('.videotime'+id).val(mediaElement.currentTime);
						
							// trigger change
							jQuery('.videotime'+id).trigger('change');
						...
						mediaElement.addEventListener('ended', function(e) { 
							...
							if(typeof jQuery('.videonextup'+id) != "undefined"){					
								setTimeout(function () {
								window.location.href = jQuery('.videonextup'+id).val();
								}, 500);
							}
...
jQuery('#wlt_search_tab1').on( "click", function() {
	...
	setTimeout(function(){ jQuery('.itemdata .itemdatawrap').removeAttr( 'style' );  }, 2000); 
...
jQuery('#wlt_search_tab2').on( "click", function() {
	...
	jQuery('#wlt_search_tab2').addClass('active');
	 ...
	 setTimeout(function(){equalheight('.grid_style .itemdatawrap');  }, 2000); 
