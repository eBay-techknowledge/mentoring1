...
<div class="heading2">Breadcrumbs Layout <span>Choose options below;</span> </div>
         ...
         <div class="form-row control-group row-fluid offset3">
                                <label class="control-label span5" data-placement="top">Display Breadcrumbs?</label>
         ...
         <div class="form-row control-group row-fluid offset3">
                                <label class="control-label span5" data-placement="top">Show Social Buttons</label>
                                <div class="controls span4">
                                  <div class="row-fluid">
                                    <div class="pull-left">
                                      <label class="radio off">
