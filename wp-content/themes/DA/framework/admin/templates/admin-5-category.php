...
<div class="heading2"> Category Selection</div>     
               ...
               <div class="form-row control-group row-fluid ">
                            <label class="control-label span4 offset2" rel="tooltip" data-original-title="Turn ON to stop users from select the parent category as a listing option." data-placement="top">Disable Parent Category</label>
  ...
  <label class="offset2">Extra Category Price</label>
