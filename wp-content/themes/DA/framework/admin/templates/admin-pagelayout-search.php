...
<label class="control-label span3 offset3">Design Layout</label>
...
<div class="form-row control-group row-fluid">
<label class="control-label span3 offset3">Columns</label>
...
<div class="form-row control-group row-fluid">
    <label class="control-label span3 offset3" for="style">2 Column Width</label>
                <div class="controls span6">
...
<div class="form-row control-group row-fluid" <?php if($core_admin_values['layout_columns']['search'] != "4"){ echo 'style="display:none;"'; } ?>>
                <label class="control-label span3 offset3" for="style">3 Column Width</label>
...
<div class="clearfix"></div>
 ...
 <div class="heading2">Display Options </div> 
        ...
        <div class="form-row control-group row-fluid">
        <label class="control-label span4 offset3" for="style">Items Per Page</label>       
        ...
        <select name="admin_values[default_gallery_perrow]" class="chzn-select" id="default_gallery_perrow">
          ...
          <option value="5" <?php selected( $core_admin_values['default_gallery_perrow'], "5" );  ?>>5 Items</option>
        </select>
        </div>
        </div>
        
          <div class="form-row control-group row-fluid ">
                            <label class="control-label span4 offset3" rel="tooltip" data-original-title="Turn on/off the inner search bar on your search results page." data-placement="top">Show Search Bar </label>
                            <div class="controls span5">
                              <div class="row-fluid">
                                <div class="pull-left">
...
<div class="form-row control-group row-fluid ">
                            <label class="control-label span4 offset3" rel="tooltip" data-original-title="Turn on/off the sort by box." data-placement="top">Show Sort By Options </label>
                            <div class="controls span5">
                              <div class="row-fluid">
                                <div class="pull-left">
                                  <label class="radio off">
		...
		<div class="heading2"> Google Map Display Options</div>     
           ...
           <div class="form-row control-group row-fluid ">
               ...
               <div class="form-row control-group row-fluid">
        <label class="control-label span4 offset3" for="style">Display Map</label>
        <div class="controls span5">
        <select name="admin_values[display_search_map]" class="chzn-select" id="display_search_map">
      
          <option value="" <?php selected( $core_admin_values['display_search_map'], "" );  ?>>Top</option>
