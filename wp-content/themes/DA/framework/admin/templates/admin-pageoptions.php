...
<div class="accordion-group">
    <div class="accordion-heading" style="background:#fff;">
        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#pagesetup_according" href="#item7">
         ...
         <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/1.png">
...
<div class="accordion-group">
    <div class="accordion-heading" style="background:#fff;">
        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#pageoptions_according" href="#op0">
         ...
         <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/14.png">
...
<div class="accordion-group">
    <div class="accordion-heading" style="background:#fff;">
        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#pageoptions_according" href="#op1">
         <h4 style="margin:0xp;font-weight:bold;">
         <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/16.png">
...
<div class="accordion-group">
    <div class="accordion-heading" style="background:#fff;">
        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#pageoptions_according" href="#op3">
         <h4 style="margin:0xp;font-weight:bold;">
         <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/17.png">
...
<div class="accordion-group">
    <div class="accordion-heading" style="background:#fff;">
        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#pageoptions_according" href="#op4">
         <h4 style="margin:0xp;font-weight:bold;">
         <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/18.png">
         Star Ratign &amp; Feedback System <span style="font-size:12px;">(view/hide)</span></h4> 
        </a>
    </div>
