...
if(isset($_POST['newzone'])  && current_user_can( 'edit_user', $userdata->ID )){
	...
	// SAVE ARRAY DATA		 
	update_option( "wlt_zones", $wlt_zones);
...
<p>Remmber, only enable advertising areas that are visible on your website. </p>
...
<div class="clearfix"></div>
    ...
    <div class="box gradient span6">
      ...
      <div class="title">
            <div class="row-fluid">
                <h3><i class="gicon-check"></i>Banner Assignment</h3>
            </div>
        </div><!-- End .title -->
        <div class="content">
