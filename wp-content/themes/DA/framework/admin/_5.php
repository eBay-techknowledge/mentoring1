    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item0">
             ...
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/19.png">
             Listing Setup Options <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        
        <div id="item0" class="accordion-body collapse in">
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item1">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/google.png">
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item2">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/core/icons/15.png">
...
<div class="box gradient">
      ...
      <div class="title">
            <div class="row-fluid"><h3> <i class="gicon-clock"></i>  Default Listing Status</h3></div>
      </div> 
...
<div class="form-row control-group row-fluid">
                ...
                <label class="control-label span12"  rel="tooltip" data-original-title="Here you can set the default status for free listings." data-placement="top">New Listing Status</label>
                ...
                <p><small><span class="label label-success" style="background:green;">Note</span> if the user pays for a listing, it will go live straight away.</small></p> 
...
<div class="box gradient">
      ...
      <div class="title">
            <div class="row-fluid"> <h3> <i class="gicon-wrench"></i>Listing Approval</h3></div>
        </div> 
...
<div class="box gradient">
      ...
      <div class="title">
            <div class="row-fluid"> <h3> <i class="gicon-time"></i> Expired Listing Display</h3></div>
        </div> 
        ...
        <div style="padding:10px; background:#fff; border:1px dashed green;">
<p><span class="label label-info">Note</span> This will hide the display of all listings which have an expired listing expiry date.</p>
</div>
        

            
              <div class="form-row control-group row-fluid ">
                            <label class="control-label span6" rel="tooltip" data-original-title="This will hide all listings with a blank or invalid listing expiry date." data-placement="top">Hide Expired</label>
                            <div class="controls span5">
                              <div class="row-fluid">
                                <div class="pull-left">
                                  <label class="radio off">
...
<div class="row-fluid">
    ...
    <div class="box gradient span4">
      ...
      <div class="title">
            <div class="row-fluid">
                <h3><i class="gicon-wrench"></i>Settings</h3>
            </div>
        </div><!-- End .title -->
        <div class="content">
      ...
      <div class="title">
	   ...
	   if(is_array($packagefields) && count($packagefields) > 0 ){ 
        ...
        <?php } ?>
             ...
             <div class="title"><div class="row-fluid"><h3><i class="gicon-cog"></i>Custom Page Text</h3></div></div><!-- End .title -->      
      <div class="content">     
