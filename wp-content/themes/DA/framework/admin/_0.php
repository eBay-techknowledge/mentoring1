...
if(get_option('wlt_db_update_85') == ""){
	$sql = "UPDATE ".$wpdb->posts." SET ".$wpdb->posts.".post_type = 'listing_type' WHERE ".$wpdb->posts.".post_type = 'coupon_type' OR ".$wpdb->posts.".post_type = 'product_type'";
 	$wpdb->query($sql);
	update_option("wlt_db_update_85","complete");
}
...
<select name="admin_values[template]" class="chzn-select" onchange="SelectSampleData(this.value)">
...
"1" => array("title" => "Setup Registration Fields", "link" =>"admin.php?page=1&tab=usersettings", "desc" =>"Create your own registration fields for users to fill in during registration.", ),
...
"4" => array("title" => "Setup Home Page", "link" => "admin.php?page=1&tab=maintab1", "desc" =>"Setup your home page display and slider images.", ), 
...
"6" => array("title" => "Setup Advanced Search Fields", "link" => "admin.php?page=1&tab=maintab4", "desc" =>"Setup searchble fields for your visitors to find website content.", ),
