...
<img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/0/0.png" width="60px" style="float:right;" />   
...
function _1_tabs(){ $STRING = ""; global $wpdb; $core_admin_values = get_option("core_admin_values");
	...
	$pages_array = array(  
	"1" => array("t" => "Layout Setup", 	"k"=>	"maintab1", "d" => true), 
	...
	$pages_array[6] = array("t" => "<i class='gicon-star'></i> Child Theme Setup", "k" => 	"childsetup");
...
<div class="tab-pane fade <?php if(isset($_POST['tab']) && $_POST['tab'] == "childsetup"){ echo "active in"; } ?>" id="childsetup" > 

	<?php get_template_part('framework/admin/templates/admin', 'childsetup' ); ?>
