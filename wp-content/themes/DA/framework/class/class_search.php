...
class Core_Advanced_Search {
    ...
    <div class="span4">
     ...
     <div class="title"><div class="row-fluid"><h3><i class="gicon-retweet"></i>Custom Orderby Options</h3></div></div>
     <div class="content">
   ...
   Price (high-low)[orderby=price&amp;order=desc]
	 ...
	 ?>
     <div class="box gradient">
     <div class="title"><div class="row-fluid"><h3><i class="gicon-wrench"></i>Settings</h3></div></div>
     <div class="content">
     <?php echo $data; ?>
     </div></div>
     <?php } $data = ""; ?>
