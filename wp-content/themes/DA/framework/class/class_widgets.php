...
class core_widgets_displayextras extends WP_Widget {  
    function core_widgets_displayextras() {
		...
		$opts = array(
			...
			'description' => __( 'Extra Display Elements' )
		);
		parent::__construct( 'core_widgets_accountbox', __( '== [PP] ==  Display Elements' ), $opts );		
    }
...
class core_widgets_tabs extends WP_Widget {  
    function core_widgets_tabs() {
		...
		parent::__construct( 'core_widgets_tabssearch', __( '== [PP] ==  Tabs Widget' ), $opts );		
    }
    function form($instance) {	
 		$defaults = array(
			'tab1'		=> 'Tab Title 1',
...
class core_widgets_googlemap extends WP_Widget { // UPDATED 6TH JULY
    function core_widgets_googlemap() {
		...
		parent::__construct( 'core_widgets_googlemapsearch', __( '== [PP] ==  Google Map' ), $opts );		
    }
    function form($instance) {	
 		$defaults = array(
...
class core_widgets_author extends WP_Widget {
    function core_widgets_author() {
		...
		parent::__construct( 'core_author', __( '== [PP] ==  Author' ), $opts );		
    }
    function form($instance) {   
		$instance = wp_parse_args( $instance, $defaults );
		$defaults = array(
...
class core_widgets_categories extends WP_Widget { // UPDATED 6TH JULY
    function core_widgets_categories() {
		...
		parent::__construct( 'core_widgets_categories', __( '== [PP] ==  Categories' ), $opts );		
    }
    function form($instance) {	
 		$defaults = array(
...
class core_widgets_blogposts extends WP_Widget {
    ...
    function core_widgets_blogposts() {
        ...
        $this->WP_Widget( 'wlt-blogposts', '== [PP] ==  Blog Posts', $widget_ops );
    }
...
class core_widgets_comments extends WP_Widget {
    ...
    function core_widgets_comments() {
        ...
        $this->WP_Widget( 'wlt-comments', '== [PP] ==  User Comments', $widget_ops );
    }
...
class Core_Advanced_Search_Widget extends WP_Widget {
    ...
    function Core_Advanced_Search_Widget() {
        ...
        $this->WP_Widget( 'advanced-search', '== [PP] ==  Advance Search', $widget_ops );
    }
...
class core_widgets_listings extends WP_Widget { // UPDATED 6TH JULY
    function core_widgets_listings() {
		...
		$opts = array(
			...
			'description' => __( 'Display a list of website listings.' )
		);
		parent::__construct( 'core_widgets_listings', __( '== [PP] ==  Listings' ), $opts );	
    }
    function form($instance) {	
 		$defaults = array(
...
class core_widgets_blank extends WP_Widget {
    ...
    function core_widgets_blank() {
		...
		parent::__construct( 'core_blank', __( '== [PP] ==  Blank Widget Area' ), $opts );		
    }
    function form($instance) {   
		$instance = wp_parse_args( $instance, $defaults );		
	 ?>
...
class core_widgets_mailinglist extends WP_Widget {
    ...
    function core_widgets_mailinglist() {
		...
		parent::__construct( 'core_widgets_mailinglist', __( '== [PP] ==  Mailing List' ), $opts );		
    }
	...
	case "1": {
        ...
        <form class="form-search" id="mailinglist-form" name="mailinglist-form" method="post" onSubmit="return IsEmailMailinglist();">
          ...
          <input type="submit" class="btn btn-default" value="<?php echo $CORE->_e(array('button','35')); ?>">
        </form>
