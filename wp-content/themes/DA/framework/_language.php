...
"english" => array(
	...
	"button" => array(			
		...
		"30" 			=> "Submit Listing",
		"31" 			=> "--- all departments ---"	,
		"32" 			=> "Add/Remove",   //this is on the profile bar text next to star    		
		"33" 			=> "Remove favorites",	 
		"34" 			=> "Get Code",	
	...
	"validate" => array(		
		...
		"28"		=> "Please add more content to your listing description.",
		"lo_a_favorite"		=> "Removed From List", 
		"lo_r_favorite"		=> "Added To List",		
	...
	"author" => array(	
		...
		"28" => "Upload Curriculum Vitae (CV) or Resume.",
	...
	"add" => array(
		...
		"24"			=> "Membership Programs",		
		"25"			=> "Our membership packages let you submit multiple listings.",		
		"26"			=> "Sign up to be a Mentor or  Mentee by creating  your Profile",		
		"27"			=> "",		
		...
		"73"			=> "Keywords are important for search criteria so you may be found - Separate each keyword with a comma.",
		"74"			=> "Display Order",		
	...
	"account" => array(
		...
		"4" 			=> "Create Listing",
		"5" 			=> "Here you can create a new CPT Mentoring listing.",
		"6" 			=> "My Listings",
		"7" 			=> "Here you can view your existing CPT Mentoring listing.",
		"8" 			=> "Logout",
		"9" 			=> "Email",
		"10" 			=> "Password",
		"11" 			=> "Re-Type Password",
		"12" 			=> "No money has been taken from your account, the transaction was not completed successfully.",	
	 	"13" 			=> "About Me/ Extra Details",
	 	"14" 			=> "CPT Mentoring",
		...
		"26" 			=> "My Messages",
		"27" 			=> "Here you can view any messages sent by a CPT Mentoring member.",
		"28" 			=> "%a New Message",
		"29" 			=> "Send Message",
		"30" 			=> "Fill out the fields below to send a private message.",
		"31" 			=> "Member Username",
		"32" 			=> "Subject",
		"33" 			=> "Message",
		"34" 			=> "Send Message",
		...
		"40" 			=> "a CPT Mentoringr visitor",		
		"41" 			=> "Phone",		
		"42"			=> "Email subscriptions have been updated",		
		"43"			=> "CPT Mentoring Membership Enabled",
		"44"			=> "My Subscriptions",
		"45"			=> "Here you can subscribe to CPT Mentoring categories and receive an email when a new listing is added.",
		"46"			=> "My Mentors/Mentees",		
		"47"			=> "Here you can view and manage your Mentor/Mentees.",				
		"48"			=> "Hide Form",
		...
		"65"			=> "<h4>Pending Admin Approval</h4> <p>Your listing will go live once it has been approved.<br /><b>Thank you for your patience.</b>",
		"66"			=> "<h4>Current Item Status:</h4>",
		"67"			=> "Renew",	 
		"68"			=> "Photo",
		"69"			=> "Remove From List",
		"70"			=> "My Members/Blocked List",
		"71"			=> "Here you can view users you have added as mentors/mentees and/or blocked.",
		"72"			=> "My Mentors/Mentees",
	...
	"callback" => array(	
		"1" 			=> " Complete",
		"2" 			=> "Thank you.",
		"3" 			=> "Completed - you will be contacted by our team shortly.",
		"7" 			=> "Failed",
		"8" 			=> "Sorry but there was an error.",
		"9" 			=> "No funds released from your account.", 
		"10"			=> "Return.",
	), 
